...
<head>
    ...
    <meta name="title" content="AXC X GODS KEYAUTH - Open Source Auth">
    ...
    <meta content="AXC X GODS KEYAUTH" name="author" />
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="AXC X GODS KEYAUTH, Cloud Authentication, Key Authentication,Authentication, API authentication,Security, Encryption authentication, Authenticated encryption, Cybersecurity, Developer, SaaS, Software Licensing, Licensing" />
    ...
    <meta property="og:site_name" content="AXC X GODS KEYAUTH | Secure your software from piracy." />
    <link rel="shortcut icon" type="image/jpg" href="https://cdn.keyauth.cc/front/assets/img/favicon.png">

    <!-- Schema.org markup for Google+ -->
    <meta itemprop="name" content="AXC X GODS KEYAUTH - Open Source Auth">
    ...
    <meta name="twitter:title" content="AXC X GODS KEYAUTH - Open Source Auth">
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="AXC X GODS KEYAUTH - Open Source Auth" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="./" />

    <title>AXC X GODS KEYAUTH - Register</title>
        ...
        <nav class="border-gray-200 px-4 lg:px-6 py-2.5 mb-14">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="../" class="flex items-center">
                    <img src="../RONALDO_IN_MANCHESTER_2008_-_cristiano_explore_manchesterunited_1.png" class="mr-3 h-12 mt-2" alt="AXC X GODS KEYAUTH Logo" />
                </a>
            ...
            <div class="w-full md:w-1/2 md:p-8">
                ...
                <h2
                    class="mb-7 md:mb-12 text-3xl md:text-6xl font-bold font-heading tracking-px-n leading-tight text-center">
                        Welcome to <span class="text-transparent bg-clip-text bg-gradient-to-r to-blue-600 from-sky-400">AXC X GODS KEYAUTH</span>!
                    </h2>
