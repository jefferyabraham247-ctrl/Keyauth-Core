...
$redisServers = []; // URLs to purge redis keys from each server (used on live AXC X GODS KEYAUTH website only)

$redisPass = "";

$keyauthStatsToken = ""; // discord bot token for AXC X GODS KEYAUTH Stats

$webhookun = "AXC X GODS KEYAUTH Logs"; // webhook username

$adminwebhookun = "AXC X GODS KEYAUTH Admin Logs"; // admin webhook's username
